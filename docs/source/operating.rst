[testproject4-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [testproject4-3f10] container is NOT running**.

.. tip::
   You must have your [testproject4-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46173  \-\-env VIPERVIZPORT=48421  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:48421/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:48421/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/testproject4-3f10-amd64 (https://hub.docker.com/r/maadsdocker/testproject4-3f10-amd64)
...
.. important::
   docker run -d -p 57357:57357 -p 53727:53727 -p 33819:33819 \-\-env TSS=0 \-\-env SOLUTIONNAME=testproject4-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-testproject4-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=57357  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53727  \-\-env SOLUTIONVIPERVIZPORT=33819 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=46173 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=48421 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/testproject4-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=33819
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=57357
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/testproject4-3f10-amd64
...
It can be accessed by entering: http://localhost:53727
...
.. important::
   http://localhost:33819/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:33819/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:33819/<html file>
...
[testproject4-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/testproject4-3f10
...
.. important::
   https://testproject4-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-testproject4-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=57357, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44359, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38745, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45457, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44613, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37801, HPDEHOST=127.0.1.1, HPDEPORT=33039, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38169

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5507-testproject4-3f10,solution_preprocessing_dag-testproject4-3f10, python-preprocess-1222-testproject4-3f10,solution_preprocessing_dag-testproject4-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
